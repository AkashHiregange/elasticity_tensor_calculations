...
from carmm.elasticity.getting_deformed_geometries import generate_deformed_strutures, create_files_and_directories
...
ase_atoms_eq = read('Co_Opt_mace_mp.traj')
...
from carmm.elasticity.elastic_tensor_calculation import read_strain_tensor_from_pkl, read_stress_from_outputs, compute_elasticity_tensor
